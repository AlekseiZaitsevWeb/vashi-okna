 ...
 */
 ...
 export default class ItcSimpleSlider {
  ...
  static CLASS_NAME_CONTROL_BLOCK = `${ItcSimpleSlider.PREFIX}__control-block`;
  ...
  static SELECTOR_CONTROL_BLOCK = `.${ItcSimpleSlider.CLASS_NAME_CONTROL_BLOCK }`;
  ...
  constructor(target, config) {
    ...
    this._elControlBlock = this._el.querySelector(ItcSimpleSlider.SELECTOR_CONTROL_BLOCK);
    // текущий индекс
  ...
  _setActiveClass() {
    ...
    // const elContolBlock = this._el.querySelector(ItcSimpleSlider.SELECTOR_CONTROL_BLOCK);
  ...
  _addIndicators() {
    ...
    this._elControlBlock.insertAdjacentHTML('beforeend', `<ol class="${ItcSimpleSlider.CLASS_NAME_INDICATORS}">${html}</ol>`);
  }
